...
| Class | Description |
| ----- | ----------- |
| `AnnotationConfigApplicationContext` | コンフィギュレーションクラスからBeanを生成するためのメタデータを読み取ってIoC Containerを生成するための実装クラス。 |
...
| Class | Description |
| ----- | ----------- |
| `AnnotationConfigWebApplicationContext` | コンフィギュレーションクラスからBeanを生成するためのメタデータを読み取ってWebアプリケーション用のIoC Containerを生成するための実装クラス。 |
